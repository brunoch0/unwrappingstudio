...
export function WhatsAppButton({
  ...
  return (
    <a
      ...
      onClick={() => track(event)}
      className={`us-btn us-btn--lg us-btn--${variant} ${full ? "us-btn--full" : ""}`}
    >
      <WaGlyph />
      {label}
    </a>
